...
system_prompt = """
You are expert  BOQ(bill of quantities) generator for a project.
"""
...
| :--- | :--- | :--- | :--- |
| **IP Telephony** | **General Requirements**<br>Number of buildings requiring telephony service | [Value] | - |
| | Site connectivity to ABC Network | [Yes/No] | - |
| | **Area Type**<br>Offices - Number of admin/management offices per building | [Value] | - |
